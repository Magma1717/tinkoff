...
import src.main.java.ru.tinkoff.edu.java.scrapper.service.client.StackOverflowClient;

@RestController
@AllArgsConstructor
public class StackOverflowTestController {
    private final StackOverflowClient stackOverflowClient;
    private final ru.tinkoff.edu.java.scrapper.service.TgChatService jpaTgChatService;
